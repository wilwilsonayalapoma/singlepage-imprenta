      ...
      <main>
        <section id="inicio" className="hero">
          <div className="container">
            ...
            <a href="https://wa.me/51999888777?text=Hola%20Imprenta%20Nuevo%20Mundo%2C%20quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20sus%20servicios" target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
        ...
        <section id="nosotros" className="section">
          <div className="container">
            ...
            <p>
              ...
              servicios de impresión offset y digital para empresas y particulares.
            </p>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="contact-grid">
              <div className="contact-card">
                <p className="contact-intro">Estamos listos para ayudarte con tu próximo proyecto.</p>
                <ul className="contact-list">
                  <li className="contact-item">
                    ...
                    <div>
                      ...
                      <p>Av. Principal 123, Centro, Lima</p>
                    </div>
                  </li>
                  <li className="contact-item">
                    <span className="contact-icon" aria-hidden="true">
                    ...
                    <div>
                      ...
                      <p>+51 999 888 777 · (01) 555 1234</p>
                    </div>
                  </li>
                  <li className="contact-item">
                    <span className="contact-icon" aria-hidden="true">
                    ...
                    <div>
                      ...
                      <p><a href="mailto:info@imprentanuevomundo.com">info@imprentanuevomundo.com</a></p>
                    </div>
                  </li>
                  <li className="contact-item">
                    <span className="contact-icon" aria-hidden="true">
              ...
              <div className="map-embed" aria-label="Mapa de ubicación">
                <iframe
                  ...
                  src="https://www.google.com/maps?q=Av.%20Principal%20123%20Lima&output=embed"
                  loading="lazy"
